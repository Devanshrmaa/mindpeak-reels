...
"[project]/src/components/FormulaDownloadModal.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const FormulaDownloadModal = ({ isOpen, onClose, formulaData })=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const { generateFormulaPdf } = await __turbopack_context__.A("[project]/src/lib/generateFormulaPdf.ts [app-ssr] (ecmascript, async loader)");
            await generateFormulaPdf(formulaData);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success('Your formula sheet PDF is downloading!');
        } catch  {
...
//# sourceMappingURL=src_components_db1aa70e._.js.map