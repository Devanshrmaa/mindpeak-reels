...
"[project]/src/lib/generateFormulaPdf.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function generateFormulaPdf(data) {
    ...
    function setFont(size) {
        let style = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 'normal';
    ...
    function split(text, maxW, size) {
        let style = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 'normal';
        setFont(size, style);
...
//# sourceMappingURL=src_lib_generateFormulaPdf_ts_fa7f50aa._.js.map