module.exports=[19322,a=>{"use strict";a.s(["default",()=>b]);let b=(0,a.i(11857).registerClientReference)(function(){throw Error("Attempted to call the default export of [project]/src/views/BlogPost.tsx <module evaluation> from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"[project]/src/views/BlogPost.tsx <module evaluation>","default")},75556,a=>{"use strict";a.s(["default",()=>b]);let b=(0,a.i(11857).registerClientReference)(function(){throw Error("Attempted to call the default export of [project]/src/views/BlogPost.tsx from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"[project]/src/views/BlogPost.tsx","default")},42922,a=>{"use strict";a.i(19322);var b=a.i(75556);a.n(b)},52519,a=>{"use strict";var b=a.i(7997),c=a.i(42922),d=a.i(49442),e=a.i(50760),f=a.i(1269);let g=(0,f.default)("Clock",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["polyline",{points:"12 6 12 12 16 14",key:"68esgv"}]]);var h=a.i(1508);let i=(0,f.default)("TrendingUp",[["polyline",{points:"22 7 13.5 15.5 8.5 10.5 2 17",key:"126l90"}],["polyline",{points:"16 7 22 7 22 13",key:"kwv8wd"}]]);var j=a.i(77695),k=a.i(52644);let l=[{slug:`top-10-jee-preparation-tips-${k.CURRENT_EXAM_YEAR}`,title:`Top 10 JEE Preparation Tips for ${k.CURRENT_EXAM_YEAR} Aspirants`,excerpt:"Master the JEE Main and Advanced with these proven strategies that have helped thousands of students achieve their IIT dreams.",category:"JEE",tags:["JEE Main","JEE Advanced","Preparation Tips","Study Strategy"],author:"Mindpeak Team",publishDate:"2026-02-15",readTime:"8 min read",icon:d.Target,color:"from-blue-500 to-cyan-500",featured:!0,content:`
# Top 10 JEE Preparation Tips for ${k.CURRENT_EXAM_YEAR} Aspirants
...
`}],m=(0,f.default)("BookOpen",[["path",{d:"M12 7v14",key:"1akyts"}],["path",{d:"M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z",key:"ruj8y"}]]),n=(0,f.default)("Calendar",[["path",{d:"M8 2v4",key:"1cmpym"}],["path",{d:"M16 2v4",key:"4m81vk"}],["rect",{width:"18",height:"18",x:"3",y:"4",rx:"2",key:"1hopcy"}],["path",{d:"M3 10h18",key:"8toen8"}]]);var o=a.i(57682),p=a.i(4437);let q=(0,f.default)("GraduationCap",[["path",{d:"M21.42 10.922a1 1 0 0 0-.019-1.838L12.83 5.18a2 2 0 0 0-1.66 0L2.6 9.08a1 1 0 0 0 0 1.832l8.57 3.908a2 2 0 0 0 1.66 0z",key:"j76jl0"}],["path",{d:"M22 10v6",key:"1lu8f3"}],["path",{d:"M6 12.5V16a6 3 0 0 0 12 0v-3.5",key:"1r8lef"}]]),r=(0,f.default)("Award",[["path",{d:"m15.477 12.89 1.515 8.526a.5.5 0 0 1-.81.47l-3.58-2.687a1 1 0 0 0-1.197 0l-3.586 2.686a.5.5 0 0 1-.81-.469l1.514-8.526",key:"1yiouv"}],["circle",{cx:"12",cy:"8",r:"6",key:"1vp47v"}]]);var s=a.i(79649);let t=(0,f.default)("Star",[["path",{d:"M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z",key:"r04s7s"}]]),u=["January","February","March","April","May","June","July","August","September","October","November","December"];function v(){return u[new Date().getMonth()]}function w(){return new Date().getFullYear()}let x=[d.Target,m,e.Brain,n,i,o.Heart,p.Microscope,j.Zap,q,r,s.Flame,t];async function y({params:a}){let b,c,d,e,f,g,h,i,j,k,m,n,o,{slug:p}=await a,q=(o=new Set((n=[(b=v(),c=w(),d=new Date().getMonth(),{slug:`jee-${c}-preparation-${b.toLowerCase()}`,title:`JEE ${c} Preparation Strategy for ${b}`,excerpt:`Complete ${b} ${c} study plan for JEE aspirants — chapter priorities, mock test targets, and daily schedule optimized for this phase of preparation.`,category:"JEE",tags:["JEE Main","JEE Advanced","Monthly Strategy",b,String(c)],author:"MindPeak Expert Team",publishDate:new Date(c,d,1).toISOString().split("T")[0],readTime:"7 min read",icon:x[d],color:"from-blue-500 to-cyan-500",content:`
# JEE ${c} Preparation Strategy for ${b}

As we enter ${b} ${c}, JEE aspirants need to adjust their preparation strategy. Here's your comprehensive guide for this month.

## Key Focus Areas for ${b} ${c}
...
- Take **${2+d%3} full-length mock tests** this week
...
## ${b} Checklist
- Complete ${5+d%4} chapters this month
- Take ${4+d%3} full-length mocks
- Revise ${8+d%5} important topics
- Clear at least ${10+2*d} doubts with your mentor

## Get Personalized Help
Struggling with this month's targets? A 1-on-1 mentor can build a study plan tailored to YOUR pace and weak areas.
    `}),(e=v(),f=w(),g=new Date().getMonth(),{slug:`neet-${f}-biology-strategy-${e.toLowerCase()}`,title:`NEET ${f} Biology Focus for ${e}`,excerpt:`${e} ${f} NEET Biology preparation guide — Botany priorities, Zoology focus, NCERT mastery plan, and practice question targets.`,category:"NEET",tags:["NEET UG","Biology","Monthly Strategy",e,String(f)],author:"MindPeak Expert Team",publishDate:new Date(f,g,1).toISOString().split("T")[0],readTime:"6 min read",icon:x[(g+6)%12],color:"from-green-500 to-emerald-500",content:`
# NEET ${f} Biology Strategy for ${e}

${e} is a crucial month for NEET Biology preparation. Here's your comprehensive guide.

## ${e} ${f} Biology Priorities
...
### Zoology Focus
Zoology topics for ${e} should emphasize Human Physiology chapters, which carry significant weightage in NEET.

### High-Yield Topics This Month
Focus on assertion-reason questions and diagram-based MCQs for maximum scoring potential.

## Practice Targets
- NCERT revision: minimum ${20+5*g} pages per day
- Previous year NEET questions: ${15+2*g} per day
- Full-length NEET mocks: ${2+g%3} this month

## ${e} Biology Checklist
- Complete ${4+g%3} Biology chapters
- Memorize ${10+2*g} key diagrams
- Solve ${100+20*g} Biology MCQs
- Revise all NCERT examples for covered chapters
    `}),(h=v(),i=w(),j=new Date().getMonth(),m=(k=[{title:"Time Management",slug:"time-management",color:"from-purple-500 to-pink-500"},{title:"Dealing with Exam Stress",slug:"exam-stress-relief",color:"from-orange-500 to-red-500"},{title:"Effective Revision Techniques",slug:"revision-techniques",color:"from-teal-500 to-blue-500"},{title:"Mock Test Strategy",slug:"mock-test-strategy",color:"from-yellow-500 to-orange-500"},{title:"Building Study Habits",slug:"building-study-habits",color:"from-indigo-500 to-purple-500"},{title:"Formula Memorization",slug:"formula-memorization",color:"from-pink-500 to-rose-500"},{title:"Staying Motivated",slug:"staying-motivated",color:"from-emerald-500 to-teal-500"},{title:"Parent Guide for JEE NEET",slug:"parent-guide",color:"from-blue-500 to-indigo-500"},{title:"Board + Competitive Exam Balance",slug:"board-exam-balance",color:"from-cyan-500 to-blue-500"},{title:"Last Month Preparation",slug:"last-month-prep",color:"from-red-500 to-orange-500"},{title:"Post-Exam Analysis",slug:"post-exam-analysis",color:"from-green-500 to-teal-500"},{title:"Year-End Review",slug:"year-end-review",color:"from-violet-500 to-purple-500"}])[j%k.length],{slug:`${m.slug}-${h.toLowerCase()}-${i}`,title:`${m.title} — ${h} ${i} Guide`,excerpt:`Expert tips on ${m.title.toLowerCase()} for JEE and NEET aspirants this ${h}.`,category:"Study Tips",tags:["Study Tips",m.title,h,String(i)],author:"MindPeak Expert Team",publishDate:new Date(i,j,5).toISOString().split("T")[0],readTime:"5 min read",icon:x[(j+3)%12],color:m.color,content:`
# ${m.title} — ${h} ${i} Guide

As a JEE / NEET aspirant in ${h} ${i}, mastering ${m.title.toLowerCase()} can make or break your preparation. Here are proven strategies from our expert mentors.

## Why ${m.title} Matters Now
With competitive exams approaching, ${m.title.toLowerCase()} becomes increasingly important. Students who master this aspect see a 15-25% improvement in their scores.
...
## How MindPeak Helps
Your personal mentor helps you build a customized ${m.title.toLowerCase()} framework tailored to your learning style and exam timeline.
    `})]).map(a=>a.slug)),[...n,...l.filter(a=>!o.has(a.slug))]).find(a=>a.slug===p);return q?{title:`${q.title} — MindPeak Blog`,description:q.excerpt,alternates:{canonical:`https://mindpeakinstitute.com/blog/${p}`},openGraph:{title:q.title,description:q.excerpt,url:`https://mindpeakinstitute.com/blog/${p}`,siteName:"MindPeak Institute",type:"article"}}:{title:"Blog Post"}}function z(){return(0,b.jsx)(c.default,{})}a.s(["default",()=>z,"generateMetadata",()=>y],52519)}];

//# sourceMappingURL=_abbc59c5._.js.map