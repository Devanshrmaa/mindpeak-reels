module.exports=[87572,a=>{"use strict";var b=a.i(50429),c=a.i(61545),d=a.i(41710),e=a.i(69439),f=a.i(24669),g=a.i(1027),h=a.i(5058);let i=[{slug:`top-10-jee-preparation-tips-${h.CURRENT_EXAM_YEAR}`,title:`Top 10 JEE Preparation Tips for ${h.CURRENT_EXAM_YEAR} Aspirants`,excerpt:"Master the JEE Main and Advanced with these proven strategies that have helped thousands of students achieve their IIT dreams.",category:"JEE",tags:["JEE Main","JEE Advanced","Preparation Tips","Study Strategy"],author:"Mindpeak Team",publishDate:"2026-02-15",readTime:"8 min read",icon:b.Target,color:"from-blue-500 to-cyan-500",featured:!0,content:`
...
`}];var j=a.i(53722),k=a.i(41675),l=a.i(76472),m=a.i(15442),n=a.i(69769),o=a.i(93518),p=a.i(16106),q=a.i(21374);let r=["January","February","March","April","May","June","July","August","September","October","November","December"];function s(){return r[new Date().getMonth()]}function t(){return new Date().getFullYear()}let u=[b.Target,j.BookOpen,c.Brain,k.Calendar,f.TrendingUp,l.Heart,m.Microscope,g.Zap,n.GraduationCap,o.Award,p.Flame,q.Star];function v(){let a,b,c,d,e,f,g,h,j,k,l,m=[(a=s(),b=t(),c=new Date().getMonth(),{slug:`jee-${b}-preparation-${a.toLowerCase()}`,title:`JEE ${b} Preparation Strategy for ${a}`,excerpt:`Complete ${a} ${b} study plan for JEE aspirants — chapter priorities, mock test targets, and daily schedule optimized for this phase of preparation.`,category:"JEE",tags:["JEE Main","JEE Advanced","Monthly Strategy",a,String(b)],author:"MindPeak Expert Team",publishDate:new Date(b,c,1).toISOString().split("T")[0],readTime:"7 min read",icon:u[c],color:"from-blue-500 to-cyan-500",content:`
# JEE ${b} Preparation Strategy for ${a}

As we enter ${a} ${b}, JEE aspirants need to adjust their preparation strategy. Here's your comprehensive guide for this month.

## Key Focus Areas for ${a} ${b}
...
- Take **${2+c%3} full-length mock tests** this week
...
## ${a} Checklist
- Complete ${5+c%4} chapters this month
- Take ${4+c%3} full-length mocks
- Revise ${8+c%5} important topics
- Clear at least ${10+2*c} doubts with your mentor

## Get Personalized Help
Struggling with this month's targets? A 1-on-1 mentor can build a study plan tailored to YOUR pace and weak areas.
    `}),(d=s(),e=t(),f=new Date().getMonth(),{slug:`neet-${e}-biology-strategy-${d.toLowerCase()}`,title:`NEET ${e} Biology Focus for ${d}`,excerpt:`${d} ${e} NEET Biology preparation guide — Botany priorities, Zoology focus, NCERT mastery plan, and practice question targets.`,category:"NEET",tags:["NEET UG","Biology","Monthly Strategy",d,String(e)],author:"MindPeak Expert Team",publishDate:new Date(e,f,1).toISOString().split("T")[0],readTime:"6 min read",icon:u[(f+6)%12],color:"from-green-500 to-emerald-500",content:`
# NEET ${e} Biology Strategy for ${d}

${d} is a crucial month for NEET Biology preparation. Here's your comprehensive guide.

## ${d} ${e} Biology Priorities
...
### Zoology Focus
Zoology topics for ${d} should emphasize Human Physiology chapters, which carry significant weightage in NEET.

### High-Yield Topics This Month
Focus on assertion-reason questions and diagram-based MCQs for maximum scoring potential.

## Practice Targets
- NCERT revision: minimum ${20+5*f} pages per day
- Previous year NEET questions: ${15+2*f} per day
- Full-length NEET mocks: ${2+f%3} this month

## ${d} Biology Checklist
- Complete ${4+f%3} Biology chapters
- Memorize ${10+2*f} key diagrams
- Solve ${100+20*f} Biology MCQs
- Revise all NCERT examples for covered chapters
    `}),(g=s(),h=t(),j=new Date().getMonth(),l=(k=[{title:"Time Management",slug:"time-management",color:"from-purple-500 to-pink-500"},{title:"Dealing with Exam Stress",slug:"exam-stress-relief",color:"from-orange-500 to-red-500"},{title:"Effective Revision Techniques",slug:"revision-techniques",color:"from-teal-500 to-blue-500"},{title:"Mock Test Strategy",slug:"mock-test-strategy",color:"from-yellow-500 to-orange-500"},{title:"Building Study Habits",slug:"building-study-habits",color:"from-indigo-500 to-purple-500"},{title:"Formula Memorization",slug:"formula-memorization",color:"from-pink-500 to-rose-500"},{title:"Staying Motivated",slug:"staying-motivated",color:"from-emerald-500 to-teal-500"},{title:"Parent Guide for JEE NEET",slug:"parent-guide",color:"from-blue-500 to-indigo-500"},{title:"Board + Competitive Exam Balance",slug:"board-exam-balance",color:"from-cyan-500 to-blue-500"},{title:"Last Month Preparation",slug:"last-month-prep",color:"from-red-500 to-orange-500"},{title:"Post-Exam Analysis",slug:"post-exam-analysis",color:"from-green-500 to-teal-500"},{title:"Year-End Review",slug:"year-end-review",color:"from-violet-500 to-purple-500"}])[j%k.length],{slug:`${l.slug}-${g.toLowerCase()}-${h}`,title:`${l.title} — ${g} ${h} Guide`,excerpt:`Expert tips on ${l.title.toLowerCase()} for JEE and NEET aspirants this ${g}.`,category:"Study Tips",tags:["Study Tips",l.title,g,String(h)],author:"MindPeak Expert Team",publishDate:new Date(h,j,5).toISOString().split("T")[0],readTime:"5 min read",icon:u[(j+3)%12],color:l.color,content:`
# ${l.title} — ${g} ${h} Guide

As a JEE / NEET aspirant in ${g} ${h}, mastering ${l.title.toLowerCase()} can make or break your preparation. Here are proven strategies from our expert mentors.

## Why ${l.title} Matters Now
With competitive exams approaching, ${l.title.toLowerCase()} becomes increasingly important. Students who master this aspect see a 15-25% improvement in their scores.
...
## How MindPeak Helps
Your personal mentor helps you build a customized ${l.title.toLowerCase()} framework tailored to your learning style and exam timeline.
    `})],n=new Set(m.map(a=>a.slug));return[...m,...i.filter(a=>!n.has(a.slug))]}function w(a){return v().find(b=>b.slug===a)}function x(a,b=3){return v().filter(b=>b.slug!==a.slug&&(b.category===a.category||b.tags.some(b=>a.tags.includes(b)))).slice(0,b)}a.s(["getAllPosts",()=>v,"resolvePostBySlug",()=>w,"resolveRelatedPosts",()=>x],87572)}];

//# sourceMappingURL=src_lib_blogResolver_ts_92e7ce57._.js.map