...
`}];var l=e.i(10980),u=e.i(87316),d=e.i(90597),m=e.i(67954),h=e.i(32095),p=e.i(42009),g=e.i(58377),y=e.i(70273);let f=["January","February","March","April","May","June","July","August","September","October","November","December"];function v(){return f[new Date().getMonth()]}function E(){return new Date().getFullYear()}let b=[t.Target,l.BookOpen,i.Brain,u.Calendar,s.TrendingUp,d.Heart,m.Microscope,n.Zap,h.GraduationCap,p.Award,g.Flame,y.Star];function k(){let e,t,i,o,a,s,n,r,l,u,d,m=[(e=v(),t=E(),i=new Date().getMonth(),{slug:`jee-${t}-preparation-${e.toLowerCase()}`,title:`JEE ${t} Preparation Strategy for ${e}`,excerpt:`Complete ${e} ${t} study plan for JEE aspirants — chapter priorities, mock test targets, and daily schedule optimized for this phase of preparation.`,category:"JEE",tags:["JEE Main","JEE Advanced","Monthly Strategy",e,String(t)],author:"MindPeak Expert Team",publishDate:new Date(t,i,1).toISOString().split("T")[0],readTime:"7 min read",icon:b[i],color:"from-blue-500 to-cyan-500",content:`
...
Struggling with this month's targets? A 1-on-1 mentor can build a study plan tailored to YOUR pace and weak areas.
    `}),(o=v(),a=E(),s=new Date().getMonth(),{slug:`neet-${a}-biology-strategy-${o.toLowerCase()}`,title:`NEET ${a} Biology Focus for ${o}`,excerpt:`${o} ${a} NEET Biology preparation guide — Botany priorities, Zoology focus, NCERT mastery plan, and practice question targets.`,category:"NEET",tags:["NEET UG","Biology","Monthly Strategy",o,String(a)],author:"MindPeak Expert Team",publishDate:new Date(a,s,1).toISOString().split("T")[0],readTime:"6 min read",icon:b[(s+6)%12],color:"from-green-500 to-emerald-500",content:`
...
## Practice Targets
- NCERT revision: minimum ${20+5*s} pages per day
- Previous year NEET questions: ${15+2*s} per day
- Full-length NEET mocks: ${2+s%3} this month

## ${o} Biology Checklist
- Complete ${4+s%3} Biology chapters
- Memorize ${10+2*s} key diagrams
- Solve ${100+20*s} Biology MCQs
- Revise all NCERT examples for covered chapters
    `}),(n=v(),r=E(),l=new Date().getMonth(),d=(u=[{title:"Time Management",slug:"time-management",color:"from-purple-500 to-pink-500"},{title:"Dealing with Exam Stress",slug:"exam-stress-relief",color:"from-orange-500 to-red-500"},{title:"Effective Revision Techniques",slug:"revision-techniques",color:"from-teal-500 to-blue-500"},{title:"Mock Test Strategy",slug:"mock-test-strategy",color:"from-yellow-500 to-orange-500"},{title:"Building Study Habits",slug:"building-study-habits",color:"from-indigo-500 to-purple-500"},{title:"Formula Memorization",slug:"formula-memorization",color:"from-pink-500 to-rose-500"},{title:"Staying Motivated",slug:"staying-motivated",color:"from-emerald-500 to-teal-500"},{title:"Parent Guide for JEE NEET",slug:"parent-guide",color:"from-blue-500 to-indigo-500"},{title:"Board + Competitive Exam Balance",slug:"board-exam-balance",color:"from-cyan-500 to-blue-500"},{title:"Last Month Preparation",slug:"last-month-prep",color:"from-red-500 to-orange-500"},{title:"Post-Exam Analysis",slug:"post-exam-analysis",color:"from-green-500 to-teal-500"},{title:"Year-End Review",slug:"year-end-review",color:"from-violet-500 to-purple-500"}])[l%u.length],{slug:`${d.slug}-${n.toLowerCase()}-${r}`,title:`${d.title} — ${n} ${r} Guide`,excerpt:`Expert tips on ${d.title.toLowerCase()} for JEE and NEET aspirants this ${n}.`,category:"Study Tips",tags:["Study Tips",d.title,n,String(r)],author:"MindPeak Expert Team",publishDate:new Date(r,l,5).toISOString().split("T")[0],readTime:"5 min read",icon:b[(l+3)%12],color:d.color,content:`
# ${d.title} — ${n} ${r} Guide

As a JEE / NEET aspirant in ${n} ${r}, mastering ${d.title.toLowerCase()} can make or break your preparation. Here are proven strategies from our expert mentors.

## Why ${d.title} Matters Now
With competitive exams approaching, ${d.title.toLowerCase()} becomes increasingly important. Students who master this aspect see a 15-25% improvement in their scores.
...
## How MindPeak Helps
Your personal mentor helps you build a customized ${d.title.toLowerCase()} framework tailored to your learning style and exam timeline.
    `})],h=new Set(m.map(e=>e.slug));return[...m,...c.filter(e=>!h.has(e.slug))]}function T(e){return k().find(t=>t.slug===e)}function w(e,t=3){return k().filter(t=>t.slug!==e.slug&&(t.category===e.category||t.tags.some(t=>e.tags.includes(t)))).slice(0,t)}e.s(["getAllPosts",()=>k,"resolvePostBySlug",()=>T,"resolveRelatedPosts",()=>w],30972)},56583,e=>{e.v(t=>Promise.all(["static/chunks/2b38c8620792b491.js","static/chunks/8d75c70d4d701047.js"].map(t=>e.l(t))).then(()=>t(64450)))},19614,e=>{e.v(t=>Promise.all(["static/chunks/2b38c8620792b491.js","static/chunks/4912435b090f4b7e.js"].map(t=>e.l(t))).then(()=>t(16127)))}]);