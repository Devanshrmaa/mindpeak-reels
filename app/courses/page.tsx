...
export const metadata: Metadata = {
  ...
  description: `Explore 12+ personalized 1-on-1 JEE & NEET programs — foundation, 1-year, 2-year, crash & Olympiad. 95% success rate, AIR 42 in JEE Advanced. Book a free demo.`,
