...
const data = competitors.find((c) => c.slug === "mindpeak-vs-fiitjee")!;
const OG_IMAGE = "https://mindpeakinstitute.com/images/og/coaching.jpg";

export const metadata: Metadata = {
  title: data.metaTitle,
  description: data.metaDescription,
  alternates: { canonical: "https://mindpeakinstitute.com/mindpeak-vs-fiitjee" },
  openGraph: {
    title: data.metaTitle,
    description: data.metaDescription,
    url: "https://mindpeakinstitute.com/mindpeak-vs-fiitjee",
