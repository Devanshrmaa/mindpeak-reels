...
export const neetBiologyChapters: ChapterData[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'How many questions come from Human Reproduction in NEET?', a: 'Human Reproduction alone contributes roughly 3-4 questions a year. But it sits inside the Reproduction unit (with Reproductive Health and Sexual Reproduction in Flowering Plants), and that whole unit is the single biggest scoring block in NEET Biology — about 10-12 questions (~22-26 marks) every year across the 2009-2024 papers. If you treat Reproduction as one unit and master it, you are protecting nearly a fifth of your Botany+Zoology marks.' },
      { q: 'Which topics in Human Reproduction are most asked?', a: 'By historical question share: Male Reproductive System (~30%), Female Reproductive System (~25%), Gametogenesis — spermatogenesis & oogenesis (~20%), then Fertilisation, Implantation and Pregnancy (~15%). The menstrual cycle appears in almost every paper, and gametogenesis/fertilisation questions are usually diagram- or stage/day-based. Learn the exact NCERT diagrams (seminiferous tubule, Graafian follicle, fertilisation stages) line by line — NEET lifts options straight from them.' },
      { q: 'Is Human Reproduction a scoring chapter for NEET, or is it hard?', a: 'It is one of the most scoring chapters precisely because it is high-weightage AND almost entirely NCERT-direct — there is very little reasoning, so accuracy beats cleverness here. The common trap is mixing up spermatogenesis vs oogenesis timing (oogenesis starts before birth and pauses; spermatogenesis begins at puberty) and FSH vs LH roles. Nail the diagrams and the hormone sequence and this becomes near-guaranteed marks.' },
      { q: 'What is the difference between spermatogenesis and oogenesis for NEET?', a: 'Both are meiotic, but the timing and yield differ. Spermatogenesis: begins at puberty, continuous, one primary spermatocyte → 4 functional sperm, equal cytoplasm division. Oogenesis: begins in the foetus (primary oocytes arrest in prophase-I before birth), resumes at puberty cycle by cycle, one primary oocyte → 1 functional ovum + 2-3 polar bodies, with unequal cytoplasm division. NEET repeatedly tests "how many functional gametes" and "where meiosis pauses" — keep those two facts crisp.' },
    ],
  },
  {
