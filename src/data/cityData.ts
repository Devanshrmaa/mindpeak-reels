...
export const cities: CityData[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'How does MindPeak compare to Hyderabad\'s top coaching centres?', a: 'While Hyderabad centres like Sri Chaitanya and Narayana teach 150+ students per batch, MindPeak provides dedicated 1-on-1 mentoring. ' },
    ],
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'How does MindPeak compare to coaching in Salt Lake area?', a: 'While Salt Lake centres offer batch coaching with 80-120 students, MindPeak provides dedicated 1-on-1 mentoring with personalised study plans. ' },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'How does MindPeak compare to FC Road coaching centres?', a: 'While FC Road centres offer batch coaching with limited personal attention, MindPeak provides dedicated 1-on-1 mentoring. Our students consistently outperform batch-coached peers, as evidenced by our 1-on-1 format.' },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'How does MindPeak compare to Sector 34 coaching centres?', a: 'While Sector 34 centres teach in batches, MindPeak provides dedicated 1-on-1 mentoring. Our personalised attention and 1-on-1 format demonstrate the superiority of individualised coaching.' },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'How does MindPeak compare to Surat coaching centres?', a: 'MindPeak provides dedicated 1-on-1 mentoring that no batch centre in Surat can match. ' },
...
export function getLocationDescription(exam: 'jee' | 'neet', city: string): string {
  ...
  const extra = exam === 'jee'
    ? 'A dedicated mentor per student. Adaptive curriculum + weekly parent reports.'
    : 'Top 500 NEET rank. AIIMS-alumni mentors. NCERT-first protocol + weekly parent reports.';
  return `Top-rated ${examLabel} coaching in ${city} with dedicated 1-on-1 online mentors. ${extra} Zero commute. Book free demo today.`;
}
