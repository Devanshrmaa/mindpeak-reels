...
const subjectPages: SEOPageData[] = [
  {
    ...
    faqs: [
      ...
      { q: 'Does MindPeak provide Physics formula sheets?', a: 'Yes! We provide comprehensive formula sheets with 150+ JEE Physics formulas tagged by exam frequency. Available for free download at /jee-physics-formulas.' },
    ],
    relatedPages: [
      { label: 'JEE Chemistry Coaching', href: '/jee-chemistry-coaching' },
      { label: 'JEE Mathematics Coaching', href: '/jee-mathematics-coaching' },
