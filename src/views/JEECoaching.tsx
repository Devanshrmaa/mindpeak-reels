          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                { label: 'JEE Advanced Coaching — IIT Preparation', to: '/jee-advanced-coaching' },
                { label: 'JEE Main Coaching Program', to: '/jee-main-coaching' },
                { label: 'JEE Dropper Coaching — Gap Year Program', to: '/jee-dropper-coaching' },
                { label: 'JEE Crash Course — 90-Day Sprint', to: '/jee-crash-course' },
                { label: 'Meet Our IIT-Alumni JEE Mentors', to: '/mentors' },
                { label: 'MindPeak Teaching Methodology', to: '/methodology' },
                { label: 'Free JEE Study Plan Generator', to: '/study-plan' },
                { label: 'JEE Student Success Stories', to: '/success-stories' },
