    ...
    <>
      ...
      <main className="bg-background pt-20">
        ...
        <section className="mx-auto max-w-4xl px-4 pb-12">
          ...
          >
            ...
            <p className="text-muted-foreground text-sm mb-6 max-w-lg mx-auto">
              Get personalised PYQ analysis, weak-chapter identification, and 1-on-1 doubt sessions with <Link to="/neet-coaching" className="text-green-400 font-semibold hover:underline">MindPeak's NEET coaching mentors</Link>.
            </p>
            <button
        ...
        <section className="mx-auto max-w-5xl px-4 pb-16">
          <h2 className="font-display font-bold text-lg text-foreground mb-5">Explore NEET Coaching, Practice & Free Tools</h2>
          <div className="flex flex-wrap gap-2">
            {[
              ...
              { to: '/neet-practice', label: 'NEET Chapter-wise Practice Questions' },
